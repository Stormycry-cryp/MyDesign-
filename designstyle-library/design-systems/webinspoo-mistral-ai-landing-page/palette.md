# Color System: WebInspoo Mistral AI Landing Page

## Observed Palette
| Color | Role | Source | Screenshot Share |
|---|---|---|---|
| `#101010` | foreground | screenshot pixel sample | 0.4317 |
| `#fffff0` | background | screenshot pixel sample | 0.1649 |
| `#202030` | deep accent | screenshot pixel sample | 0.0381 |
| `#60a0f0` | accent | screenshot pixel sample | 0.0067 |
| `#2070d0` | accent | screenshot pixel sample | 0.0055 |
| `#ff5010` | accent | screenshot pixel sample | 0.0053 |
| `#4080e0` | accent | screenshot pixel sample | 0.0049 |
| `#404040` | foreground | screenshot pixel sample | 0.0043 |
| `#e0e0e0` | neutral surface | screenshot pixel sample | 0.0032 |
| `#e02000` | accent | screenshot pixel sample | 0.0019 |
