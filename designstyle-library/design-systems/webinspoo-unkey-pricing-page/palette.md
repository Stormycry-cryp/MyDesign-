...
|---|---|---|---|
| `#101010` | foreground | screenshot pixel sample | 0.4319 |
| `#ffffff` | background | screenshot pixel sample | 0.0316 |
...
| `#404040` | foreground | screenshot pixel sample | 0.005 |
...
| `#e0f040` | accent | screenshot pixel sample | 0.0026 |
