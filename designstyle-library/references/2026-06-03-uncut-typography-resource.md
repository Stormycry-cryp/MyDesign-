...
structure_tags: ["homepage", "type-index", "resource-navigation"]
motion_tags: ["transition", "hover", "scroll"]
code_tags: ["public-css", "public-js"]
best_for: ["type resource pages", "open-source design libraries", "typography-led indexes"]
avoid_for: ["SaaS dashboards", "luxury retail", "travel hospitality"]
community_signal: "Httpster typography/resource candidate; selected as contrast to Counter Forms for type-led resource UI"
page_scope: "homepage typography resource index"
evidence_screenshot: "screenshots/uncut-typography-resource-desktop.png"
evidence_quality: "visual screenshot plus DOM/style/resource extraction"
---

# Style Reference: Uncut Typography Resource

## Essence
Uncut Typography Resource is captured as a typography, design-resource, open-source, culture reference for homepage typography resource index. Reuse the observable structure, asset handling, component density, and motion evidence below; do not treat the brand identity as the reusable part.

## When To Use
- Use for homepage typography resource index work where the category fit is typography, design-resource, open-source, culture.
- Use when the desired mechanics match these observed tags: type-led, resource, raw, minimal, homepage, type-index, resource-navigation, transition, hover, scroll.
...
- Screenshot: screenshots/uncut-typography-resource-desktop.png
...
- Images observed: Preview of typeface Tanklager 0x0 https://uncut.wtf/assets/images/tanklager.svg; Preview of typeface Opening Hours Sans 0x0 https://uncut.wtf/assets/images/opening-hours-sans.svg; Preview of typeface LT Institute 0x0 https://uncut.wtf/assets/images/lt-institute.svg; Preview of typeface Geist 0x0 https://uncut.wtf/assets/images/geist.svg; Preview of typeface Berlin Grotesk 0x0 https://uncut.wtf/assets/images/berlin-grotesk.svg; Preview of typeface Hedvig Letters Sans 0x0 https://uncut.wtf/assets/images/hedvig-letters-sans.svg; Preview of typeface Liga Sans 0x0 https://uncut.wtf/assets/images/liga-sans.svg; Preview of typeface Overused Grotesk 0x0 https://uncut.wtf/assets/images/overused-grotesk.svg
...
## Visual System
- Layout: infer from screenshot and viewport; primary page text sample starts `UNCUT.wtf Download somewhat contemporary fonts, free for commercial use UNCUT.wtf is a free typeface catalogue, focusing on somewhat contemporary type. There are currently 163 typefaces featured. Grid List Search SANS SERIF 66 Close SERIF 27 Close MONOSPACE 23`.
- Typography: observed font stacks and role rhythm are recorded below.
- Color: observed computed foreground/background pairs are recorded below.
- Density: navigation count 0, image count 40, document height 1652.
- Shape: border radii samples recorded below.
- Shadow/depth: inspect screenshot; automated pass records no shadow taxonomy.

## Typography And Reading Rhythm
- Observed font stack counts: BODY:UncutSansWeb, fallback, system-ui, -apple-system, sans-serif:24.48px:400:normal:29.376px; H1:UncutSansWeb, fallback, system-ui, -apple-system, sans-serif:24.48px:400:normal:29.376px; P:UncutSansWeb, fallback, system-ui, -apple-system, sans-serif:24.48px:400:normal:29.376px; P:UncutSansWeb, fallback, system-ui, -apple-system, sans-serif:24.48px:400:normal:29.376px; P:UncutSansWeb, fallback, system-ui, -apple-system, sans-serif:24.48px:400:normal:29.376px; P:UncutSansWeb, fallback, system-ui, -apple-system, sans-serif:24.48px:400:normal:29.376px; H2:UncutSansWeb, fallback, system-ui, -apple-system, sans-serif:61.2px:400:-0.918px:58.752px; P:UncutSansWeb, fallback, system-ui, -apple-system, sans-serif:36.72px:400:normal:44.064px; P:UncutSansWeb, fallback, system-ui, -apple-system, sans-serif:24.48px:400:normal:48.96px; H2:UncutSansWeb, fallback, system-ui, -apple-system, sans-serif:61.2px:400:-0.918px:58.752px; P:UncutSansWeb, fallback, system-ui, -apple-system, sans-serif:36.72px:400:normal:44.064px; P:UncutSansWeb, fallback, system-ui, -apple-system, sans-serif:24.48px:400:normal:48.96px
- Observed font sizes: H1:UncutSansWeb, fallback, system-ui, -apple-system, sans-serif:24.48px:400:normal:29.376px; P:UncutSansWeb, fallback, system-ui, -apple-system, sans-serif:24.48px:400:normal:29.376px; P:UncutSansWeb, fallback, system-ui, -apple-system, sans-serif:24.48px:400:normal:29.376px; P:UncutSansWeb, fallback, system-ui, -apple-system, sans-serif:24.48px:400:normal:29.376px; P:UncutSansWeb, fallback, system-ui, -apple-system, sans-serif:24.48px:400:normal:29.376px; H2:UncutSansWeb, fallback, system-ui, -apple-system, sans-serif:61.2px:400:-0.918px:58.752px; P:UncutSansWeb, fallback, system-ui, -apple-system, sans-serif:36.72px:400:normal:44.064px; P:UncutSansWeb, fallback, system-ui, -apple-system, sans-serif:24.48px:400:normal:48.96px; H2:UncutSansWeb, fallback, system-ui, -apple-system, sans-serif:61.2px:400:-0.918px:58.752px; P:UncutSansWeb, fallback, system-ui, -apple-system, sans-serif:36.72px:400:normal:44.064px; P:UncutSansWeb, fallback, system-ui, -apple-system, sans-serif:24.48px:400:normal:48.96px; H2:UncutSansWeb, fallback, system-ui, -apple-system, sans-serif:61.2px:400:-0.918px:58.752px; P:UncutSansWeb, fallback, system-ui, -apple-system, sans-serif:36.72px:400:normal:44.064px; P:UncutSansWeb, fallback, system-ui, -apple-system, sans-serif:24.48px:400:normal:48.96px; H2:UncutSansWeb, fallback, system-ui, -apple-system, sans-serif:61.2px:400:-0.918px:58.752px; P:UncutSansWeb, fallback, system-ui, -apple-system, sans-serif:36.72px:400:normal:44.064px
...
- Macro geometry: document size {'w': 1440, 'h': 1000, 'docW': 1440, 'docH': 1652}.
...
## Assets
- Image style: Preview of typeface Tanklager; Preview of typeface Opening Hours Sans; Preview of typeface LT Institute; Preview of typeface Geist; Preview of typeface Berlin Grotesk; Preview of typeface Hedvig Letters Sans; Preview of typeface Liga Sans; Preview of typeface Overused Grotesk
