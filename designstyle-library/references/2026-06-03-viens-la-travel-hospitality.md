---
title: "Viens La Travel Hospitality"
source_url: "https://viens-la.com/"
captured_at: "2026-06-03"
tags: ["travel", "hospitality", "service", "culture", "destination-led", "editorial", "experiential", "warm", "homepage", "travel-service", "brand-story", "transition", "hover", "scroll", "public-css", "public-js"]
category_tags: ["travel", "hospitality", "service", "culture"]
style_tags: ["destination-led", "editorial", "experiential", "warm"]
structure_tags: ["homepage", "travel-service", "brand-story"]
motion_tags: ["transition", "hover", "scroll"]
code_tags: ["public-css", "public-js"]
best_for: ["travel service sites", "hospitality landing pages", "destination-led brand stories"]
avoid_for: ["developer docs", "fintech dashboards", "typography archives"]
community_signal: "Httpster travel/hospitality candidate; selected for destination-led service storytelling and category diversity"
page_scope: "homepage travel hospitality service"
evidence_screenshot: "screenshots/viens-la-travel-hospitality-desktop.png"
evidence_quality: "visual screenshot plus DOM/style/resource extraction"
---

# Style Reference: Viens La Travel Hospitality

## Essence
Viens La Travel Hospitality is captured as a travel, hospitality, service, culture reference for homepage travel hospitality service. Reuse the observable structure, asset handling, component density, and motion evidence below; do not treat the brand identity as the reusable part.

## When To Use
- Use for homepage travel hospitality service work where the category fit is travel, hospitality, service, culture.
- Use when the desired mechanics match these observed tags: destination-led, editorial, experiential, warm, homepage, travel-service, brand-story, transition, hover, scroll.

## When Not To Use
- Do not use when the task needs a different page scope than `homepage travel hospitality service` and no secondary page evidence is available.
...
## Evidence Snapshot
- Captured URL: https://viens-la.com/
- Page title: Viens-là | Agence digitale & branding sur-mesure — Paris
- Screenshot: screenshots/viens-la-travel-hospitality-desktop.png
...
- Images observed: icon 25x25 https://viens-la.com/wp-content/themes/front/assets/svgs/icons/arrow-right.svg; icon 25x25 https://viens-la.com/wp-content/themes/front/assets/svgs/icons/arrow-right.svg; icon 25x25 https://viens-la.com/wp-content/themes/front/assets/svgs/icons/arrow-right.svg; icon 25x25 https://viens-la.com/wp-content/themes/front/assets/svgs/icons/arrow-right.svg; forme 48x48 https://viens-la.com/wp-content/themes/front/assets/svgs/shapes/circle.svg; icon 25x25 https://viens-la.com/wp-content/themes/front/assets/svgs/icons/guide.svg; icon 25x25 https://viens-la.com/wp-content/themes/front/assets/svgs/icons/arrow-right.svg; icon 25x25 https://viens-la.com/wp-content/themes/front/assets/svgs/icons/arrow-right.svg
- Video observed: https://viens-la.com/wp-content/themes/front/assets/videos/vl_showreel_small.mp4; https://viens-la.com/wp-content/themes/front/assets/videos/vl_showreel_small.mp4
...
- Observed font stack counts: BODY:obviously-variable, sans-serif:15px:400:normal:28.125px; A:obviously-variable, sans-serif:15px:400:normal:28.125px; A:obviously-variable, sans-serif:15px:400:normal:28.125px; A:obviously-variable, sans-serif:15px:400:normal:28.125px; A:obviously-variable, sans-serif:15px:400:normal:28.125px; A:obviously-variable, sans-serif:15px:400:normal:28.125px; A:obviously-variable, sans-serif:12px:400:normal:18.6px; A:obviously-variable, sans-serif:12px:400:normal:18.6px; H1:obviously-variable, sans-serif:12px:400:normal:24px; BUTTON:obviously-variable, sans-serif:27px:400:normal:27.54px; H2:obviously-variable, sans-serif:15px:400:normal:28.125px; A:obviously-variable, sans-serif:15px:400:normal:28.125px
- Observed font sizes: A:obviously-variable, sans-serif:15px:400:normal:28.125px; A:obviously-variable, sans-serif:15px:400:normal:28.125px; A:obviously-variable, sans-serif:15px:400:normal:28.125px; A:obviously-variable, sans-serif:15px:400:normal:28.125px; A:obviously-variable, sans-serif:15px:400:normal:28.125px; A:obviously-variable, sans-serif:12px:400:normal:18.6px; A:obviously-variable, sans-serif:12px:400:normal:18.6px; H1:obviously-variable, sans-serif:12px:400:normal:24px; BUTTON:obviously-variable, sans-serif:27px:400:normal:27.54px; H2:obviously-variable, sans-serif:15px:400:normal:28.125px; A:obviously-variable, sans-serif:15px:400:normal:28.125px; H3:obviously-variable, sans-serif:240px:400:normal:244.8px; A:obviously-variable, sans-serif:15px:400:normal:28.125px; H3:obviously-variable, sans-serif:240px:400:normal:244.8px; A:obviously-variable, sans-serif:15px:400:normal:28.125px; H3:obviously-variable, sans-serif:240px:400:normal:244.8px
...
- Observed text colors: BODY:rgb(95, 69, 242):rgb(95, 69, 242); A:rgb(95, 69, 242):rgba(0, 0, 0, 0); A:rgb(255, 255, 255):rgb(95, 69, 242); A:rgb(95, 69, 242):rgba(0, 0, 0, 0); A:rgb(95, 69, 242):rgba(0, 0, 0, 0); A:rgb(95, 69, 242):rgba(0, 0, 0, 0); A:rgb(95, 69, 242):rgba(0, 0, 0, 0); A:rgb(255, 255, 255):rgb(95, 69, 242); A:rgb(95, 69, 242):rgba(0, 0, 0, 0); BUTTON:rgb(95, 69, 242):rgba(0, 0, 0, 0); P:rgb(255, 255, 255):rgba(0, 0, 0, 0); BUTTON:rgb(95, 69, 242):rgb(255, 227, 117); BUTTON:rgb(95, 69, 242):rgb(150, 241, 198); BUTTON:rgb(95, 69, 242):rgb(255, 196, 140); BUTTON:rgb(95, 69, 242):rgb(157, 236, 250); BUTTON:rgb(255, 255, 255):rgb(83, 59, 240)
...
## Assets
- Image style: icon; icon; icon; icon; forme; icon; icon; icon
...
- Buttons/links: DÉCOUVRIR LA VIDÉO DES 15 ANS; DÉCOUVRIR LA VIDÉO DES 15 ANS; VOIR NOS RÉALISATIONS; VOIR NOS RÉALISATIONS; VOIR NOS RÉCOMPENSES; VOIR NOS RÉCOMPENSES
...
- Reuse value: useful for homepage travel hospitality service if category and screenshot match the future task.
