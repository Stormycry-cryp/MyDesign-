...
structure_tags: ["pricing-page", "plans", "enterprise", "faq"]
motion_tags: ["transition", "hover", "scroll"]
code_tags: ["public-css", "public-js"]
best_for: ["AI SaaS pricing pages", "enterprise plan comparison", "pricing structure analysis"]
avoid_for: ["studio portfolios", "food service", "travel sites"]
community_signal: "WebInspoo AI/SaaS pricing page entry; selected for AI product pricing pattern coverage"
page_scope: "AI SaaS pricing page inspiration"
evidence_screenshot: "screenshots/webinspoo-braintrust-pricing-page-desktop.png"
evidence_quality: "visual screenshot plus DOM/style/resource extraction"
---

# Style Reference: WebInspoo Braintrust Pricing Page

## Essence
WebInspoo Braintrust Pricing Page is captured as a ai, saas, pricing, inspiration reference for AI SaaS pricing page inspiration. Reuse the observable structure, asset handling, component density, and motion evidence below; do not treat the brand identity as the reusable part.

## When To Use
- Use for AI SaaS pricing page inspiration work where the category fit is ai, saas, pricing, inspiration.
- Use when the desired mechanics match these observed tags: pricing-clarity, ai-led, structured, conversion, pricing-page, plans, enterprise, faq, transition, hover, scroll.

## When Not To Use
- Do not use when the task needs a different page scope than `AI SaaS pricing page inspiration` and no secondary page evidence is available.
...
- Reuse value: useful for AI SaaS pricing page inspiration if category and screenshot match the future task.
