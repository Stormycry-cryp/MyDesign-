...
- Macro geometry: document size {'w': 1440, 'h': 1000, 'docW': 1440, 'docH': 7445}.; source: Layout Geometry And Spacing
- Media/card aspect stability: image natural sizes include 1200x2; 0x0; 240x240; 240x240; 240x240; 240x240; 240x240; 240x240; 240x240; 240x240.; source: Layout Geometry And Spacing
- Viewport and document: {'w': 1440, 'h': 1000, 'docW': 1440, 'docH': 7445}; source: Dimension And Ratio System
- Observed media ratios: 1200:2; 240:240; 240:240; 240:240; 240:240; 240:240; 240:240; 240:240; 240:240; 240:240; source: Dimension And Ratio System
- component load motion uses 1000ms linear; source: motion.json
- component state-change motion uses 350ms ease-in-out; source: motion.json
- component state-change motion uses 250ms ease-in-out; source: motion.json
- navigation state-change motion uses 350ms ease-in-out; source: motion.json
- navigation state-change motion uses 350ms ease-out; source: motion.json
- navigation state-change motion uses 1000ms ease-out; source: motion.json
...
- H1/H2/eyebrow/CTA samples: H1 We are a data visualization studio that focuses on building meaningful experiences with data.; Other Ways to Reach Us; H2 About; Clients; Get in Touch; navigation PITCH INTERACTIVE; Work; About; Clients; Contact
...
- Voice and naming: page title Pitch Interactive: Data Visualization Studio | Award-Winning Design; source: Evidence Snapshot
...
- Component computed-style evidence: `assets/2026-06-11-pitch-interactive-data-studio-component-styles.json`
...
- Computed component styles: `assets/2026-06-11-pitch-interactive-data-studio-component-styles.json`
...
- Structured motion evidence: `assets/2026-06-11-pitch-interactive-data-studio-motion.json`
