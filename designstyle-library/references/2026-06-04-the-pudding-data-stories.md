---
title: "The Pudding Data Stories"
source_url: "https://pudding.cool/"
captured_at: "2026-06-04"
tags: ["data-storytelling", "editorial", "information-display", "playful", "visual", "story-gallery", "data-card-grid", "editorial-index", "restrained", "story-interaction", "public-dom", "css-js-probe"]
category_tags: ["data-storytelling", "editorial", "information-display"]
style_tags: ["playful", "editorial", "visual"]
structure_tags: ["story-gallery", "data-card-grid", "editorial-index"]
motion_tags: ["restrained", "story-interaction"]
code_tags: ["public-dom", "css-js-probe"]
best_for: ["data stories", "visual essays", "information display galleries"]
avoid_for: ["operational dashboards", "government portals"]
community_signal: "Passed 2026-06-04 UI aesthetic probe; kept as data-story reference, not dashboard core."
page_scope: "home/story index plus secondary links"
evidence_screenshot: "screenshots/the-pudding-data-stories-desktop.png"
evidence_quality: "visual screenshot plus DOM/style/resource extraction"
---

# Style Reference: The Pudding Data Stories

## Essence
The Pudding Data Stories is captured as a data-storytelling, editorial, information-display reference for home/story index plus secondary links. Reuse the observable structure, asset handling, component density, and motion evidence below; do not treat the brand identity as the reusable part.

## When To Use
- Use for home/story index plus secondary links work where the category fit is data-storytelling, editorial, information-display.
- Use when the desired mechanics match these observed tags: playful, editorial, visual, story-gallery, data-card-grid, editorial-index, restrained, story-interaction.

## When Not To Use
- Do not use when the task needs a different page scope than `home/story index plus secondary links` and no secondary page evidence is available.
...
- Screenshot: screenshots/the-pudding-data-stories-desktop.png
...
- Images observed: about sticker 450x240 https://pudding.cool/assets/stickers/about@2x.png; subscribe sticker 806x241 https://pudding.cool/assets/stickers/subscribe@2x.png; more sticker 454x240 https://pudding.cool/assets/stickers/more@2x.png; About 450x240 https://pudding.cool/assets/stickers/about@2x.png; Subscribe 806x241 https://pudding.cool/assets/stickers/subscribe@2x.png; Donate 601x240 https://pudding.cool/assets/stickers/donate@2x.png; Pitch Us 516x240 https://pudding.cool/assets/stickers/pitch_us@2x.png; Resources 559x240 https://pudding.cool/assets/stickers/resources@2x.png
...
- Observed font stack counts: BODY:"Gooper SemiCondensed", "Iowan Old Style", "Times New Roman", Times, serif:16px:400:normal:22.4px; A:"Gooper SemiCondensed", "Iowan Old Style", "Times New Roman", Times, serif:16px:400:normal:22.4px; P:"Atlas Grotesk", -apple-system, "system-ui", Helvetica, Arial, sans-serif:14px:400:normal:18.55px; BUTTON:"Atlas Typewriter", Menlo, Consolas, Monaco, monospace:12.8px:400:normal:14.72px; BUTTON:"Atlas Typewriter", Menlo, Consolas, Monaco, monospace:12.8px:400:normal:14.72px; BUTTON:"Atlas Typewriter", Menlo, Consolas, Monaco, monospace:12.8px:400:normal:14.72px; BUTTON:"Atlas Typewriter", Menlo, Consolas, Monaco, monospace:12.8px:400:normal:14.72px; BUTTON:"Atlas Typewriter", Menlo, Consolas, Monaco, monospace:12.8px:400:normal:14.72px; BUTTON:"Atlas Typewriter", Menlo, Consolas, Monaco, monospace:12.8px:400:normal:14.72px; P:"Atlas Typewriter", Menlo, Consolas, Monaco, monospace:14px:400:normal:19.6px; P:"Atlas Typewriter", Menlo, Consolas, Monaco, monospace:14px:400:normal:19.6px; A:"Gooper SemiCondensed", "Iowan Old Style", "Times New Roman", Times, serif:16px:400:normal:22.4px
- Observed font sizes: A:"Gooper SemiCondensed", "Iowan Old Style", "Times New Roman", Times, serif:16px:400:normal:22.4px; P:"Atlas Grotesk", -apple-system, "system-ui", Helvetica, Arial, sans-serif:14px:400:normal:18.55px; BUTTON:"Atlas Typewriter", Menlo, Consolas, Monaco, monospace:12.8px:400:normal:14.72px; BUTTON:"Atlas Typewriter", Menlo, Consolas, Monaco, monospace:12.8px:400:normal:14.72px; BUTTON:"Atlas Typewriter", Menlo, Consolas, Monaco, monospace:12.8px:400:normal:14.72px; BUTTON:"Atlas Typewriter", Menlo, Consolas, Monaco, monospace:12.8px:400:normal:14.72px; BUTTON:"Atlas Typewriter", Menlo, Consolas, Monaco, monospace:12.8px:400:normal:14.72px; BUTTON:"Atlas Typewriter", Menlo, Consolas, Monaco, monospace:12.8px:400:normal:14.72px; P:"Atlas Typewriter", Menlo, Consolas, Monaco, monospace:14px:400:normal:19.6px; P:"Atlas Typewriter", Menlo, Consolas, Monaco, monospace:14px:400:normal:19.6px; A:"Gooper SemiCondensed", "Iowan Old Style", "Times New Roman", Times, serif:16px:400:normal:22.4px; H3:"Gooper SemiCondensed", "Iowan Old Style", "Times New Roman", Times, serif:32px:500:-0.8px:32px; P:"Atlas Grotesk", -apple-system, "system-ui", Helvetica, Arial, sans-serif:16px:400:normal:22.4px; P:"Atlas Typewriter", Menlo, Consolas, Monaco, monospace:14px:400:normal:19.6px; P:"Atlas Typewriter", Menlo, Consolas, Monaco, monospace:14px:400:normal:19.6px; A:"Gooper SemiCondensed", "Iowan Old Style", "Times New Roman", Times, serif:16px:400:normal:22.4px
...
## Assets
- Image style: about sticker; subscribe sticker; more sticker; About; Subscribe; Donate; Pitch Us; Resources
