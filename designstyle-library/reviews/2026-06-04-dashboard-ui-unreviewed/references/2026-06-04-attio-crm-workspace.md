---
title: "Attio CRM Workspace"
source_url: "https://attio.com/"
captured_at: "2026-06-04"
tags: ["crm", "saas", "dashboard", "minimal", "polished", "dense-but-calm", "workspace-preview", "table-detail-composition", "product-led-hero", "restrained", "scroll-reveal", "public-dom", "css-js-probe"]
category_tags: ["crm", "saas", "dashboard"]
style_tags: ["minimal", "polished", "dense-but-calm"]
structure_tags: ["workspace-preview", "table-detail-composition", "product-led-hero"]
motion_tags: ["restrained", "scroll-reveal"]
code_tags: ["public-dom", "css-js-probe"]
best_for: ["CRM dashboards", "relationship data workspaces", "high-density SaaS UI"]
avoid_for: ["campaign-only pages", "heavy illustration sites"]
community_signal: "Selected from UI-aesthetic dashboard shortlist for polished CRM workspace information design."
page_scope: "home plus product/secondary links"
evidence_screenshot: "screenshots/attio-crm-workspace-desktop.png"
evidence_quality: "visual screenshot plus DOM/style/resource extraction"
---

# Style Reference: Attio CRM Workspace

## Essence
Attio CRM Workspace is captured as a crm, saas, dashboard reference for home plus product/secondary links. Reuse the observable structure, asset handling, component density, and motion evidence below; do not treat the brand identity as the reusable part.

## When To Use
- Use for home plus product/secondary links work where the category fit is crm, saas, dashboard.
- Use when the desired mechanics match these observed tags: minimal, polished, dense-but-calm, workspace-preview, table-detail-composition, product-led-hero, restrained, scroll-reveal.
...
## Evidence Snapshot
- Captured URL: https://attio.com/
- Page title: Attio: Ask more from CRM
- Screenshot: screenshots/attio-crm-workspace-desktop.png
- Viewport: {'w': 1440, 'h': 1000, 'docW': 1440, 'docH': 13002}
- Community signal: Selected from UI-aesthetic dashboard shortlist for polished CRM workspace information design.
...
- Images observed: image 0x0 https://a.storyblok.com/f/234930/40x40/6b7e650997/navigation-ask-attio-light-2.svg; image 0x0 https://a.storyblok.com/f/234930/40x40/94a08879f5/navigation-ask-attio-dark-3.svg; image 0x0 https://a.storyblok.com/f/234930/40x40/319415fd4d/navigation-ai-light.svg; image 0x0 https://a.storyblok.com/f/234930/40x40/55885fd463/navigation-ai-dark.svg; image 0x0 https://a.storyblok.com/f/234930/40x40/7b06c284d7/navigation-data-light.svg; image 0x0 https://a.storyblok.com/f/234930/40x40/4bb779e3e2/navigation-data-dark.svg; image 0x0 https://a.storyblok.com/f/234930/40x40/cf8e6abe56/navigation-collaboration-light.svg; image 0x0 https://a.storyblok.com/f/234930/40x40/b713f5083d/navigation-collaboration-dark.svg
- Video observed: none observed
- Overlays or fixed elements: clicked common overlay buttons Continue; inspect screenshot before final use.
...
- Observed font stack counts: BODY:inter, "inter Fallback":16px:500:-0.16px:22px; BUTTON:inter, "inter Fallback":15px:500:-0.16px:22px; BUTTON:inter, "inter Fallback":15px:500:-0.16px:22px; A:inter, "inter Fallback":15px:500:-0.16px:22px; A:inter, "inter Fallback":15px:500:-0.16px:22px; A:inter, "inter Fallback":14px:500:-0.07px:20px; A:inter, "inter Fallback":14px:500:-0.07px:20px; P:interDisplay, "interDisplay Fallback":56px:600:-0.84px:60px; P:inter, "inter Fallback":16px:500:-0.16px:22px; A:inter, "inter Fallback":16px:500:-0.16px:22px; H1:interDisplay, "interDisplay Fallback":64px:600:-1.28px:64px; P:inter, "inter Fallback":20px:500:-0.2px:26px
- Observed font sizes: BUTTON:inter, "inter Fallback":15px:500:-0.16px:22px; BUTTON:inter, "inter Fallback":15px:500:-0.16px:22px; A:inter, "inter Fallback":15px:500:-0.16px:22px; A:inter, "inter Fallback":15px:500:-0.16px:22px; A:inter, "inter Fallback":14px:500:-0.07px:20px; A:inter, "inter Fallback":14px:500:-0.07px:20px; P:interDisplay, "interDisplay Fallback":56px:600:-0.84px:60px; P:inter, "inter Fallback":16px:500:-0.16px:22px; A:inter, "inter Fallback":16px:500:-0.16px:22px; H1:interDisplay, "interDisplay Fallback":64px:600:-1.28px:64px; P:inter, "inter Fallback":20px:500:-0.2px:26px; A:inter, "inter Fallback":14px:500:-0.07px:20px; BUTTON:inter, "inter Fallback":14px:500:-0.07px:20px; BUTTON:inter, "inter Fallback":15px:500:-0.16px:20px; BUTTON:inter, "inter Fallback":15px:500:-0.16px:20px; BUTTON:inter, "inter Fallback":15px:500:-0.16px:20px
...
- Observed text colors: BODY:lab(10.7201 -0.0959039 -1.54182):lab(99.9987 0.0337958 0.000309944); HEADER:lab(10.7201 -0.0959039 -1.54182):oklab(0.999997 0.0000899732 0.000023365 / 0.95); A:lab(10.7201 -0.0959039 -1.54182):rgba(0, 0, 0, 0); BUTTON:lab(20.5697 -0.638425 -4.44436):rgba(0, 0, 0, 0); BUTTON:lab(20.5697 -0.638425 -4.44436):rgba(0, 0, 0, 0); A:lab(20.5697 -0.638425 -4.44436):rgba(0, 0, 0, 0); A:lab(20.5697 -0.638425 -4.44436):rgba(0, 0, 0, 0); A:lab(20.5697 -0.638425 -4.44436):lab(99.9987 0.0337958 0.000309944); A:lab(96.1596 -0.0828803 -1.13571):lab(12.7212 0.103362 -2.22102); SECTION:lab(10.7201 -0.0959039 -1.54182):rgba(0, 0, 0, 0); P:lab(10.7201 -0.0959039 -1.54182):rgba(0, 0, 0, 0); P:lab(76.2541 -1.09726 -7.09252):rgba(0, 0, 0, 0); A:lab(10.7201 -0.0959039 -1.54182):rgba(0, 0, 0, 0); H1:lab(10.7201 -0.0959039 -1.54182):rgba(0, 0, 0, 0); P:lab(37.426 -1.09151 -9.33263):rgba(0, 0, 0, 0); A:lab(96.1596 -0.0828803 -1.13571):lab(12.7212 0.103362 -2.22102)
...
## Assets
- Image style: https://a.storyblok.com/f/234930/40x40/6b7e650997/navigation-ask-attio-light-2.svg; https://a.storyblok.com/f/234930/40x40/94a08879f5/navigation-ask-attio-dark-3.svg; https://a.storyblok.com/f/234930/40x40/319415fd4d/navigation-ai-light.svg; https://a.storyblok.com/f/234930/40x40/55885fd463/navigation-ai-dark.svg; https://a.storyblok.com/f/234930/40x40/7b06c284d7/navigation-data-light.svg; https://a.storyblok.com/f/234930/40x40/4bb779e3e2/navigation-data-dark.svg; https://a.storyblok.com/f/234930/40x40/cf8e6abe56/navigation-collaboration-light.svg; https://a.storyblok.com/f/234930/40x40/b713f5083d/navigation-collaboration-dark.svg
...
- Navigation: Customers; Pricing; Sign in; Start for free
- Buttons/links: Platform; Resources; Customers; Pricing; Sign in; Start for free; Start for free; Talk to sales; Ask Attio; Data model; Workflows; Reporting
